...
sortedImmortal=df[order(df$mortality1990),]
...
#2020
sortedImmortal=df[order(df$mortality2020),]
headAndTail= head(sortedImmortal,5)
headAndTail = rbind(headAndTail,tail(sortedImmortal,5))
...
for (i in 1:N) {
  ...
  diff = (sortedImmortal$mortality2020[i]-sortedImmortal$mortality1990[i])/sortedImmortal$mortality1990[i]
